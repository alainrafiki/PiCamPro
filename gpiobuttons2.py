...
# The PiTFT comes with some built in options for button control (backlight and shut down), 
# but I never really understood why as it's easy to start your 
# own Python script on boot to control whatever you want - much more fun!
...
# The GPIO pins feeding these buttons are set high by default, so to trigger them you 
# have to tell your script to look for 'FALSE'...let me show you my script - copy it, tweak it, 
# freak it - go for it! I'd love to hear what you've done with your PiTFT buttons.
